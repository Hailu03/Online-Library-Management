      ...
      for (let i = 1; i <= 5; i++) {
        stars.push(
          <span
            ...
            style={{ fontSize: "58px", cursor: "pointer", color: i <= rating ? "green" : "black" }}
          >
            ★
          </span>
        );
            ...
            <section>
                <div className="banner-review">
                    <div className='banner-text-review'>
                        ...
                        <br />
                        <p className='header-text-review fs-18 fw-3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
